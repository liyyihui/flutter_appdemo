...
class HomeData {
  ...
  HomeData.fromParams({this.errorCode, this.errorMsg, this.data});

  factory HomeData(jsonStr) => jsonStr == null ? null : jsonStr is String ? new HomeData.fromJson(json.decode(jsonStr)) : new HomeData.fromJson(jsonStr);
